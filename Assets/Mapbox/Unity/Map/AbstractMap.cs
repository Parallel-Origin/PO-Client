...
namespace Mapbox.Unity.Map {
    ...
    public class AbstractMap : MonoBehaviour, IMap {
        ...
        /// <summary>
        /// Modified version... for multi threading.
        /// </summary>
		...
		private IEnumerator TriggerTileRedrawForExtent(ExtentArgs currentExtent) {
            ...
            foreach (var item in _activeTiles) {
                ...
                if (_tileProvider.Cleanup(item.Key)) {
            ...
            foreach (var tile in _currentExtent) {
                ...
                if (!_activeTiles.ContainsKey(tile)) {
                    ...
                    //this.StartCoroutineAsync(TileProvider_OnTileAdded(tile));
                    yield return TileProvider_OnTileAdded(tile);
                }
            }
        }
        ...
        public virtual void SetCenterLatitudeLongitude(Vector2d centerLatitudeLongitude) {
            ...
            _options.locationOptions.latitudeLongitude = string.Format(CultureInfo.InvariantCulture, "{0},{1}", centerLatitudeLongitude.x, centerLatitudeLongitude.y);
