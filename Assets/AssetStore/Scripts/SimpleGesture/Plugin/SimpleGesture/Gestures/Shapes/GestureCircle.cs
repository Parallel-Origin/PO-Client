...
public class GestureCircle : BaseGesture {
    ...
    protected override void OnEnded(TouchInfo touchInfo) {
        if (this.IsCircle(touchInfo)) {
            if (this.broadcastOnCircle != null)
                this.broadcastOnCircle();
