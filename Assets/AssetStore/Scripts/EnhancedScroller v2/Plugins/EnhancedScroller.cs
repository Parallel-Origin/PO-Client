...
namespace EnhancedUI.EnhancedScroller
{
    ...
    public delegate void CellViewVisibilityChangedDelegate(ListElement cellView);
    ...
    public class EnhancedScroller : MonoBehaviour
    {
        ...
        /// <returns></returns>
        public ListElement GetCellView(ListElement cellPrefab)
        {
            ...
            if (cellView == null)
            {
                ...
                cellView = go.GetComponent<ListElement>();
        ...
        /// </summary>
        private SmallList<ListElement> _recycledCellViews = new SmallList<ListElement>();
        ...
        /// </summary>
        private SmallList<ListElement> _activeCellViews = new SmallList<ListElement>();
        ...
        /// <returns></returns>
        private ListElement _GetRecycledCellView(ListElement cellPrefab)
        {
            for (var i = 0; i < _recycledCellViews.Count; i++)
            {
        ...
        private void _RecycleCell(ListElement cellView)
        {
